  ...
  return (
    <SidebarWrapper>
      <div>
        ...
        />
        <p>
          Hi, and welcome to my site! I hope you are enjoying the content. If
          you find the information valuable, please consider sharing it with
          others - it helps me a lot. Thanks, and I hope to see you here again
          soon!
        </p>
      </div>
    </SidebarWrapper>
